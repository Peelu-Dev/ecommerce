import { EmailOutlined, Facebook, Instagram, LocalPhoneOutlined, LocationOnOutlined,  Twitter, WhatsApp } from "@material-ui/icons";
  ...
  return (
    ...
    <div className="flex items-center justify-around p-2 mobile:flex-col mobile:items-start">
      <div className="flex-1 flex flex-col flex-wrap p-2">
        <h1 className="text-[25px]">Raghuwanshi Collection</h1>
        <p>
        ...
        <div className="flex items-center justify-center mt-3 self-start">
          ...
          <div className={socialStyle + ` bg-pink-500`}>
            <Instagram />
          </div>
          ...
          <div className={socialStyle + ` bg-green-500`} >
              <WhatsApp/>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col p-2">
        <div className="flex m-3">
            ...
            <p className='pl-3'>Madhya Pradesh</p>
        </div>
        <div className="flex m-3">
            <LocalPhoneOutlined className="text-[#521da8]"/>
            <p className='pl-3'>+91 9174151700</p>
        </div>
        <div className="flex m-3">
            <EmailOutlined className="text-[#8a4af3]"/>
            <p className='pl-3'>palashraghuwanshi16@gmail.com</p>
        </div>
      </div>
    </div>
  );
